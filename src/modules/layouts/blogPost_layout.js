...
export default ({children, pageContext}) => {
  ...
  `);
    ...
    const contributors = hasContributors
        ? authors.slice(1, authors.length)
        : [];
    ...
    return (
        <Flex sx={{flexDirection: "column"}}>
            ...
            {hasContributors ? (
                <ContentBlock>
                    <h2 sx={{fontWeight: "500", fontSize: "32px"}}>
                        {" "}
                        Contributors{" "}
                    </h2>
                    <p sx={{mb: "40px"}}>
                        This article is possible with a little help from
                        friends.
                    </p>
