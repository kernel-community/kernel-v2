...
### (1) Culture, Rituals & Vibrations (Community, Creative Content, Design)
...
We will be encouraging you to use our [convo app](https://convo.kernel.community/), and all the [internal tools you have learnt about how to host](https://kernel.community/en/guiding/guides) healthy and thought-provoking conversations, in order to create convos in which you invite friends, family or other familiar faces and give them a taste of KERNEL.
...
### (2) Building Community Tools & Patterns (Legal, Finance, Engineering, Product)
...
1. **The Infinite Game** (Legal, Fundraising, Finance)   
...
2. **Infrastructure for Communities of Care** (Engineering, Product, Design) 
...
Make sure you are subscribed to the [Conversations](https://calendar.google.com/calendar/u/1?cid=Y19qYm83cHFlZ2pjcmE4NTV2aWR0M2lpbzA0NEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t) Calendar. Please note this calendar is not usually compatible beyond Gmail/iCal email accounts.
