...
1. **The Infinite Game** (Legal, Finance, Product) - What does a ‘shared endowment’ look like in the context of blockchains, DAO’s, and networks owned by no-one? Could this be the basis for a KERNEL Endowment Fund? If so, how might it be structured?
