...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html">
    Read
</Button>
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://docs.openzeppelin.com/openzeppelin/">
    Secure
</Button>
...
Again, given the interdisciplinary focus here, insightful documents which are not tools can be found in the [Research section](/resources/resources/#zero-knowledge).
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://github.com/iden3">
    Construct
</Button>
