...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://medium.com/@austin_48503/%EF%B8%8Fethereum-dev-speed-run-bd72bcba6a4c">
    Tinker
</Button>
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://docs.soliditylang.org/en/v0.8.8/introduction-to-smart-contracts.html">
    Explore
</Button>
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://docs.soliditylang.org/en/v0.8.8/solidity-by-example.html#solidity-by-example">
    Copy
</Button>
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://www.youtube.com/watch?v=v_hU0jPtLto&list=PL16WqdAj66SCOdL6XIFbke-XQg2GW_Avg">
    Watch
</Button>
...
A good resource for Solidity exploits and better patterns for your latest contracts.
...
A YouTube channel for getting started with blockchain development.
...
A growing set of in-depth examples to get your hands truly dirty.

<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://speedrunethereum.com/">
    Quest
</Button>
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://github.com/scaffold-eth/scaffold-eth">
    Develop
</Button>
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="http://moonshotcollective.space/">
    Take Off
</Button>
...
<Button sx={{ alignSelf: "flex-start", mt: "auto" }} to="https://smartcontractdb.com/tutorials">
    Link Up
</Button>
