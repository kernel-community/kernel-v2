...
Andrej and his team will lead you through exactly <Link to="https://deepwork.studio/1035-2/">how to prototype</Link> and <Link to="https://www.notion.so/How-to-run-user-tests-fast-0e3ea190c9a34afabeb7eef9fdd7ef69">how to run user tests</Link>, with a list of <Link to="https://deepwork.studio/case-studies/">fantastic case studies</Link>. A strong favourite of all Kernel fellows so far.

<Button to="https://deepwork.studio/tools" sx={{ alignSelf: "flex-start", mt: "auto" }}>
    Prototype
</Button>
...
<Button to="https://www.nngroup.com/articles/why-you-only-need-to-test-with-5-users/">
    Understand
</Button>
...
<Button to="https://rimble.consensys.design/" sx={{ alignSelf: "flex-start", mt: "auto" }}>
    Create
</Button>
...
Andrej introduces a streamlined sprint process for building awesome prototypes in 4 days flat.
