...
headerOrder: 2
title: Play
description: The Kernel Gaming Track will teacj you the skills and perspectives required to build games that allow us all to play increasingly principled infinite games with one another.
...
Firesides are held weekly on **Wednedays 10 AM EST**. [Click Here to add it to your calendar 📅](https://www.addevent.com/calendar/RU314582)
...
> <Link to="http://hcsoftware.sourceforge.net/passage/statement.html">Your interpretation of the game is more important than my intentions.</Link>

<Link to="http://hcsoftware.sourceforge.net/passage/statement.html">
