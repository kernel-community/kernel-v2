...
Fortunately, Lehdonvirta and Castranova dig deep into these concepts in [Virtual Economies: Design and Analysis](/track-gaming/module-0/curated.md#virtual-economies-design-and-analysis). The whole book is a rich space for understanding value, and should be required reading for any web 3 builder. 
...
<Link to="https://en.gameslol.net/adventure-capitalist-1086.html"><Image src="/images/gaming-img/adcap.png" alt="Adventure Capitalist" /></Link>

<Link to="https://en.gameslol.net/adventure-capitalist-1086.html">Adventure Capitalist</Link> - One of the pioneers of the idle game genre. Perhaps value can just be measured in clicks and 🍋s?