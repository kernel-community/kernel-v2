...
<Link to="https://store.steampowered.com/app/1070710/Kind_Words_lo_fi_chill_beats_to_write_to/"><Image src="/images/gaming-img/ScrollingRequests.gif" alt="Kind Words" /></Link>

<Link to="https://store.steampowered.com/app/1070710/Kind_Words_lo_fi_chill_beats_to_write_to/"><Image src="/images/gaming-img/WriteLetter.gif" alt="Kind Words" /></Link>


<Link to="https://store.steampowered.com/app/1070710/Kind_Words_lo_fi_chill_beats_to_write_to/">Kind Words </Link> - A game that epitomizes giving. Write anonymous notes about what currently troubles you, and receive heartwarming letters of support in response from real people all over the world. **Use your words to lift others and be lifted in return.**