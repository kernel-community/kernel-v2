...
2. Switch your network (at the top of the browser pop-up) to the ‘Rinkeby Test Network’.
3. Get Rinkeby ETH from the faucet by following [these instructions](https://faucet.rinkeby.io/).
