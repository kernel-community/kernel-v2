...
Reflect for a moment on the game of forking documents presented in [The Declaration of Interdependence](https://www.interdependence.online/about), or the way that the [pluriverse](https://pluriverse.world/) plays with the concept of Terms of Use Agreement. Here are even more examples of permeable boundaries between "in-game" and "real-life" economies and sites of meaning.

Of course, these don't look much like traditional games, though many which do - like [Dark Forest](https://zkga.me/) - exhibit similar features. This game sparked the (loopy) development of [0xparc](https://www.0xparc.org/blog/program-for-applied-research), which is funded largely by people who played Dark Forest.

The core point about the freedom to play boundaries is that truly skillful players - those magisters of the infinite arts - know that the core skill is humility. As Nicky Case writes:
