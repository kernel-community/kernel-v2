...
3. _Optional_: watch previous firesides with Juan (IPFS) and David and Manasi (Sia) [here](https://kernel.community/en/learn/module-3/). You can find the fireside with Sam (Arweave) [here](https://zoom.us/rec/share/BlkULebaMZvGciBxQ9W7PcddPi8dcnhYo7bklkJSraS5chLZFUDx0dJJEdiGlAVK.nCfGGu-CxJfgBVtZ) (pswd: Kernel_b3).
