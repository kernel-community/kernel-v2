...
DeSci is, in some part, about the difficulty of sharing knowledge wisely, and then about how wise sharing relates to the activity of doing science itself. That is, this guild is primarily concerned with how we can 
...
You'll notice that point 3 takes us into the realm of the activity of science and how better discovery, curation, funding and publishing mechanisms might advance our collective abilities to do "good" science. Of course, just what constitutes "good" science is also a curious question...

## Principia

Here is our hypothesis: **simple pairs of principles can lead to generative shared structures**. 
...
The word "[free](/learn/module-3/freedom)" has a double directedness we consider regularly in Kernel. This means there is not just a financial/incentive aspect to this principle, but an ethical one. We also imply by this principle [freedom as in sharing, honour, hospitality](/learn/module-3/freedom/#free-software). This interpretation of the word is equally critical, not just for ethical reasons, but because sharing, honour and hospitality enable not just collaboration, but cross-disciplinary collaboration. DeSci requires scientists, curators, reviewers, editors, publishers, promoters, investors, lay readers, and many more. When you make work available to all, they imbue it with the [value of their unique attention](https://www.youtube.com/watch?v=cuBpOXGLn_o&t=4013s).
...
In AI circles, this is often talked about under the topic of "alignment", which can perhaps be maintained by ensuring there is a "human-in-the-loop". Incentive systems can be similarly powerful, but there are some differences highlighted by the different lenses above. In particular, incentive structures which work in the absence of human input are an important socio-political (and game-theoretic) tool. However, they need to be responsive to and adapt based on human attention in order to achieve the epistemic goals of DeSci.
...
Anyone who seeks to know may be considered a scientist, though that knowledge is always tested [in relationship with others](/guiding/guides/relating-kernel) and by virtue of replicable, falsifiable experiments.
