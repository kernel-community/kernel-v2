...
DeSci is, in some part, about co-creating knowledg and then sharing it wisely, and then about how wise sharing relates to the activity of doing science itself. That is, this guild is primarily concerned with how we can: 
...
Enhance a diversity of thinking and mathodology (through inclusive collaborations with diverse groups of people)
...
- inspiring, so that sharing isn't just efficient but sparks or catlyzes further and more diverse kinds of curious investigations
