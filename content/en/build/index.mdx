...
Therefore, the Build Track is organsied into more ephemeral "build guilds", which will likely change or be updated for each new block. The intention is exactly the same: we wish to impart the necessary skills you need to participate meaningfully in web3. The way we do so differs: rather than a largely static syllabus, we invite the best builders, creators, artists, inventors, hackers, tinkerers and gift-givers to present shorter courses in an area of their speciality.
