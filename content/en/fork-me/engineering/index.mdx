...
It's great to speak the language of online community building, but one needs solid technical foundations on which to build truly transformative ways of interacting and relating. This site is a building-block which sits on top of our [open smart contracts](/fork-me/learning-curve) that define the actual protocols for a better kind of money, in order to show you how high the temple pillars can really reach.
