...
buttons, Calls to Action (CTAs), images, headers etc. can be found inside the [pallete](/resources/recipes/palette/). Gradually with time contributors progress to passing your own props to
