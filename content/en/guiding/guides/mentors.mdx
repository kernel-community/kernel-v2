...
Mentor is the name of Telemachus' adviser is _The Odyssey_. Its etmyology points at one who is a "wise adviser or intimate friend, an also a sage counselor". This being Kernel, we're most excited about the notion of **intimate friendship**.
...
Of course, providing this help is not a one-way street. By agreeing to mentor Kernel Fellows each Friday, you get early insights into the latest and greatest things being built in web3. This is the fabled alpha you find whispered about on Twitter, except it's not about yield: it's about all the friends we get to make along the way.
