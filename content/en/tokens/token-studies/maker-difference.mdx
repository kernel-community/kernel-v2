...
You can follow he work done by Steakhouse in various other places, too. We recommend going to the [ENS forums](https://discuss.ens.domains/t/ens-financial-reporting-by-steakhouse/16601) next if this kind of granular data analysis interests you. We are particularly impressed by the breadth and specificty of the [dune queries](https://dune.com/queries/2244104) they continue to create to track the flow of value in and around these kind of DAOs.