...
As such, we invite you to consider [the dweb principles](https://getdweb.net/principles) as an example of what integral understandings of free software in our day and age look like. As is stated in the preamble: 

> "These stand alongside other sets of principles that share or expand upon these values, in recognition that our efforts to build a more just and equitable world are **interdependent**."
...
We strongly encourage you to read the principles yourself in full. Here, we present only a few choice phrases which illustrate why these principles play such a prominent role in our own thinking:
...
We go to such lengths to emphasise interdependence and mutuality in a post about freedom because **freedom is a means**; it is not actually an end. This is a point made best by [Harold Davis III in response](/conversation/hospitality/deep-response/#freeing-civilization) to David Graeber and David Wengrow's book _The Dawn of Everything_.

Harold illustrates that our obsessive focus on freedom as an end in itself misses all the thinking done by indigenous cultures for whom freedom was a given, based on the way their societies were structured around mutual aid. Nowhere in this post have we yet asked, "What can be done with freedom?" Yet, the dweb principles are precisely that. They are not a manifesto about our rights as "free individuals"; they are a nuanced and collaborative description of the kinds of worlds we can create when interdependence, mutuality, respect and care are our guiding lights.
