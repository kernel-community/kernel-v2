...
Revolutions always end up failing because they are reliant on people whose priorities change. There is something ambiguous in each of us, and this is a wonderful thing. However, a smart contract I wrote that expresses a particular [economic ideal](https://etherscan.io/address/0x5bCF2767F86f14eDd82053bfBfd5069F68C2C5F8#code), which is now deployed on mainnet, will remain there irrespective of what happens to me. There is no bribe or threat which can get me to change this. I literally cannot take it back, even if my life depends on it. 
