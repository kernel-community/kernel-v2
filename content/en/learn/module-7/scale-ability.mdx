...
To illustrate how rich the results are when no-one owns the means by which we communicate, we can turn to Cicero's interpretation of religion as _relegere_, or "read again". Let's start by returning to read more deeply the roots of this highly contested word. mapachurro reminds us:
