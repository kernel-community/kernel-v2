...
[mathematical tour](http://people.math.harvard.edu/~ctm/home/text/others/shannon/entropy/entropy.pdf) through universal languages and the incomplete search for linguistic perfection. 
...
Q: What paradoxical statement did Gödel use to prove incompleteness? Turing showed that incompleteness is actually an immediate corollary of what? Uncomputability shows that there are no perfect languages, though there are universal ones. A universal language is one in which what can be written?
...
Q: "Better" universal languages for computation are defined in terms of what linguistic feature? Are the most expressive languages those with the biggest or smallest programs? The most efficient universal languages can be used to define programs in what kind of way?
