...
Assumed knowledge, like heliocentricism or the existence of a particular God, creates the 
...
reward-oriented hierarchy”. By calling it so, I maybe able to show that particular dynamic 
...
The **purpose** of society can be envisioned, which is better means to meet our needs; the use of freedom from need for enjoyment of diversity and difference; the exploration of ideas; and the implementation of inventions.
...
**language** linger on. This is *exactly why* shared networks which merge the two explicitly 
...
> 💡 The problem is not primarily social or political. It is *linguistic*.
...
Marxist analysis is a great starting point, but what it lacks - and what Brün dreams of - is a 
[economy of signs](https://docs.google.com/document/d/12jZtKiHH8hjSH-OMCuPqf0jbGZ3aLYJpGr7c_mBMQy4/edit?usp=sharing) largely free from the accumulated inertia of past paradigms.
...
> Anarchist-inspired revolutionary 'networks' and 'convergences' employ decision-making processes which assume that no ideological uniformity can or should be possible. Rather, these forms become ways of managing a [diversity](/learn/module-7/giving/#further-afield), even incommensurability, which is **seen as a value in itself** [...] It is precisely what most outside observers take to be the foolishness and naivete of the movement (their apparent lack of coherent ideology) has turned out to be a token of their most sophisticated accomplishment and contribution to revolutionary theory [...] These new forms of organization, which presume and are ways of articulating a diversity of perspectives, _are_ its ideology [...] They are a collection of approaches to social reality which are united not in their aspiration to impose themselves as the only legitimate approach, as if they were so many sects trying to seize power, but rather, by their shared commitment to a project and ethics which refuses to do so.

The refusal to adopt certain practices and products is an essential aspect of the three freedoms outlined in [The Dawn of Everything](/conversation/hospotality). The freedom to refuse, to disobey, is critical to reigniting our shared political imagination and finding better ways to live together outside the reward hierarchy and its imposition of a historical meta-narrative which centers progress and makes it seem as if the "inevitable" march towards it necessitates sacrificing what makes us truly human.
