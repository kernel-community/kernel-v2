...
Q: When your running code already establishes economic consensus, do you need strong exception processing for people's technical objections such that we collectively explore only one option? Why?

A: No! Because **votes are funds** and so many different approaches can potentially be funded without addressing all technical objections in the preliminary stages.
...
Q: What kind of pattern of reasoning is it to see organic entities as resources to be organized in a legibile way which yields uniformly high returns? What ideologies are most prone to thinking this way?
