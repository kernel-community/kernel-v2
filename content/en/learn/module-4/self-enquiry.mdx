...
The point remains, however, that we must leverage the multiple forms and functions made available by open protocols in order to ensure that our identities can be composed in ways which act against the current trend on social media to collapse you into a single profile, intending only to make your interests legible to advertisers.
...
Identity proofs are about your "sovereign rights". However, we can better enable an assemblage of our needs by assessing not sovereignity, but \_\_\_\_\_\_\_\_\_\_\_\_\_\_.
...
There are no doors the the Absolute.<br/>
There is only the door through which you emerged.<br/>
Call it 'I am'.<br/>
Returning to it, passing through it,<br/>
is the only way.<br/>
<br/>
[Wu Hsin](https://www.youtube.com/watch?v=vD6F3rIuo5g&list=PLWzYrEdlV4O4i8fHqNOwXK9S077EA7TnE)
