...
From before Ethereum was even launched, the dream has been one defined by reflection, introspection, meaning, and shared value. [Mihai writes that](https://blog.ethereum.org/2014/07/14/the-ethereum-project/),
...
Prompt: Making our own money means we can aim for more than taking profit. Mihai says this 'more' can be found in our own \_\_\_\_\_\_\_ \_\_\_\_\_\_\_.
...
Prompt: Do these contracts define what you can do (substantive) or what you may do (formal)?
...
Prompt: Are these substantive contracts prescriptive or opt-in?
...
Prompt: Good "laws" on Ethereum provide what two distinct advantages?
...
Prompt: Contractual law cannot be broken (in the traditional sense), though we can choose not to follow such laws at all. These two facts together allow us to apply what method to governance?
...
Prompt: When we warp non-cooperative games into coalitional ones with an immutable and public medium, the rational choice becomes what?
...
Prompt: Human organisation changes when we are able to reduce what?
...
Prompt: We can reframe free-riders as publics we ought to serve by attending to what?
