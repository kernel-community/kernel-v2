...
This has been true since Phil Zimmerman published the source code for 
<Link to="https://books.google.co.za/books/about/PGP_Source_Code_and_Internals.html?id=xR4ZAQAAIAAJ&redir_esc=y" >PGP as a book</Link> 
...
More practically, <Link to="https://en.wikipedia.org/wiki/Space_frame" >space frames</Link> 
are a commonly used architectural design, extended into 
<Link to="http://www.grunch.net/synergetics/docs/bellnote.html" >octagonal trusses by Buckminster Fuller</Link> 
in his work on geodesic domes. Fuller is often quoted in crypto circles, with this being the go-to choice 
...
"To know is to possess, and any fact is possessed by everyone who knows it, whereas those who 
*feel* truth are possessed, not possessors." - 
