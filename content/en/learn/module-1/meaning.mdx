...
More practically, <Link to="https://en.wikipedia.org/wiki/Space_frame">space frames</Link> are a commonly used architectural design, extended into <Link to="http://www.grunch.net/synergetics/docs/bellnote.html">octagonal trusses by Buckminster Fuller</Link> in his work on geodesic domes. Fuller is often quoted in crypto circles, with this being the go-to choice 
