...
Ethereum's state is defined as a...?
...
How do we prevent a blockchain with a Turing-complete script from halting?

By charging "gas" for every computational step and limiting the amount of gas consumed per block, preventing infinite loops and other attacks.
...
The 12 or 24 words used to generate your private key and grant you access to a blockchain is called a \_\_\_\_\_\_\_\_?
