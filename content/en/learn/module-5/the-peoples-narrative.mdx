...
transactional facts in time](/learn/module-4/the-garden/#no-more-guards) such that no-one can claim ownership of either order or fact. Listen to [Kevin Kelly](/learn/module-2/better-questions/#68-life-lessons): "there is no them". There is - to use Dr Hunt's own words - only one crowd trying to look in the mirror to figure out what the crowd truly thinks.
