...
Prompt: Common knowledge games are how we model what?

Other people's behavior (or: the strategic behaviour of market participants).
...
Prompt: What must we think in terms of in order to play the player and understand how power structures really operate?
...
Prompt: What two elements are involved in the creation of common knowledge and its impact on markets? 
...
Prompt: What ironic name is given to the "operations" of the Federal Reserve when it acts as missionary?
...
Prompt: How can we undermine the actions of nudging nation states?
