...
Learning how to learn is more like a process. But it is a process with very specific characteristics. It requires a sincere desire to know; a determination to practice what you know every day; a passion that will not let you stop until you know; and a heart clear enough to know its own [intention](/learn/module-3/intention/) for pursuing knowledge at all.
...
As is often the case in these personal briefs, the primary focus is you. [You are the subject](https://www.youtube.com/watch?v=QHKrXUHXmO4). When this knowing-being is stabilised in your heart, then the environments you find yourself in all serve as means to direct you home into the silent awareness which grounds all real learning. 
