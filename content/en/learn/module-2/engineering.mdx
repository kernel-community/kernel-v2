...
Changing what we tax: rather than income, tax land and consumption.

</Process>

This is not to suggest that we financialize care, but rather that we figure out increasingly artistic ways of [incentivizing healthy relationships](https://so-far.online/a-new-circuit-reunion/) of many different kinds. What we seek to create is a more convivial society:
