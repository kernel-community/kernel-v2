...
This is not to suggest that we financialize care, but rather figure out increasingly artistic way of [incentivizing healthy relationships](https://so-far.online/a-new-circuit-reunion/) of many different kinds. What we seek to create is a more convivial society:
