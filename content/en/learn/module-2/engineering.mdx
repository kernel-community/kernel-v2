...
Remember, money-as-a-protocol allows us to program incentives at scales never 
...
Kernel will suggest, over the next seven weeks, that we can consider at least one more critical feature as a part of our engineering efforts. Transactions, work and organisation are all about relationships and capabilities. Kernel asks, 

> Can we create a culture where I am wealthy by virtue of what I care for, rather than what I control? Where wealth means “having enough to share” because who you are is already enough. Can we create environments where what I hold is valuable because of how it cultivates the expression of care within community?

<Video src="https://www.youtube-nocookie.com/embed/p1lXhTzlCVk?start=258" />

Much like Niran Babalola in [Module 1](/learn/module-1/#week-1-firesides) we wish to reimagine [the meaning of welfare](https://youtu.be/tV49vVMPsYo?t=346), and suggest that we can enact this practically by 
...
This is not to suggest that we financialize care, but rather that we figure out increasingly artistic ways of [incentivizing healthy relationships](https://so-far.online/a-new-circuit-reunion/) of many different kinds. We seek to create a more reciprocal, convivial society:
