...
meaningful communication with anyone, anywhere, in [any way we care](http://www.tomatleeblog.com/archives/175328665) to program it.
...
Prompt: Is a tamperproof, borderless, ownerless, global record a new kind of money or a new language?
...
Prompt: On a blockchain, what you say is deterministically linked to what you pay. We can therefore regulate expression economically by defining meaning as any speech which does what?
...
Prompt: Does the convoluted legal concept of free speech even apply to blockchains? 

Not really. There is only increasingly costly expression for increasingly complex kinds of meaning.

</Card>

<Card>

Prompt: Does the lack of free speech limit the ways in which anyone can express themselves?
